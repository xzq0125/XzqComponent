...
import com.xzq.module_base.base.lifecycle.LifecycleFragment;
...
public abstract class SimpleLoadingFragment extends LifecycleFragment implements ILoadingListView {

    private static final String TAG = "SimpleLoadingFragment";
